  ...
  return (
    <>
      ...
      >
        ...
        <motion.span
          variants={chipChildVariants}
          className="bg-orange-700 px-2 flex items-center justify-center text-center rounded-xl"
        >
          AWS EC2
        </motion.span>
        <motion.span
        ...
        <motion.span
          variants={chipChildVariants}
          className="bg-indigo-500 px-2 flex items-center justify-center text-center rounded-xl"
        >
          Framer Motion
        </motion.span>
      </motion.div>
